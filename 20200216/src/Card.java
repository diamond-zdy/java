...
public class Card {
    public static void main(String[] args) {
        ...
        people[0] = new Person1("zdy",18);
        people[1] = new Person1("haha",34);
        people[2] = new Person1("wzl",20);
    ...
    public static void main3(String[] args) {
        ...
        Student student1 = new Student("zdy");
        Student student2 = new Student("zdy");
        list.add(student1);
        System.out.println(list.contains(student2));
    }
    public static void main2(String[] args) {
        Person[] people = new Person[3];
        people[0] = new Person("zdy",18);
        people[1] = new Person("haha",34);
        people[2] = new Person("wzl",20);
        Arrays.sort(people);
        System.out.println(Arrays.toString(people));
    }
    public int rank;
